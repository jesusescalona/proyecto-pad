...
- Clonar el [proyecto-pad](https://github.com/jonathanaraul/proyecto-pad.git)
...
- Desde la consola (Windows: Git Bash) ejecutar los comandos: 
	...
	- php artisan db:seed		--> Ejecuta los scripts encargados de llenar la base de datos con la información por defecto
